...
function GymEquipment({ equipment, openModal }: { equipment: Equipment; openModal: EquipmentReservation["openModal"] }) {
    ...
    return (
        <>
            <div className="equipment flex flex-col items-center w-128 shadow-2xl text-slate-100 py-5 px-6 rounded-xl">
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    <button onClick={handleClick} className="bg-pink-700 text-xl px-5 py-1 border-2 border-t-gray-300 rounded-xl">Prenota!</button>
